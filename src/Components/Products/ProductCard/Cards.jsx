    ...
    <div className="max-w-sm rounded-md overflow-hidden shadow-lg mb-10 bg-white">
      <div className="relative">
        ...
        <div
          ...
          } hover:bg-rose-600 hover:text-white focus:outline-none focus:ring transition-colors duration-300 cursor-pointer active:bg-rose-500 active:border-blue-600`}
        >
