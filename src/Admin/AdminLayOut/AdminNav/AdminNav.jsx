...
export default function Header() {
  ...
  return (
    <header className="bg-white">
      <nav
        className="mx-auto flex max-w-7xl items-center justify-between -auto  lg:px-8 "
        aria-label="Global"
      >
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                <div className="flex h-screen w-fit flex-col justify-between border-e e bg-white top-0 absolute left-0">
                  <div className="h-screen w-56 ">
                    <div className="flex h-full flex-col overflow-y-auto rounded-br-lg rounded-tr-lg bg-white pt-5 shadow-md">
                      ...
                      <div className="flex mt-3 flex-1 flex-col">
                        <nav>
                          ...
                          <div className="relative transition">
                            <button
                              ...
                              className="flex relative w-full items-center border-l-rose-600 py-3 px-4 text-sm font-medium text-gray-600 outline-none transition-all duration-100 ease-in-out hover:border-l-4 hover:text-rose-600 focus:border-l-4"
                            >
                            ...
                            <ul
                              className={`flex m-2 flex-col overflow-hidden rounded-xl bg-gray-100 font-medium transition-all duration-300 ${
                        ...
                        <span className="ml-3 mb-2 block text-xs font-semibold text-gray-500">
                          Management
                        </span>
